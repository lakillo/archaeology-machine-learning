...
| task                                       | authors                              |   year | data type                                                      | technique                                                | paper                                                              | code                                                  | data       |
|:-------------------------------------------|:-------------------------------------|-------:|:---------------------------------------------------------------|:---------------------------------------------------------|:-------------------------------------------------------------------|:------------------------------------------------------|:-----------|
| semantic segmentation of buildings, platforms and aguadas | Kokalj et al.  |   2023 | multimodal data [lidar visualisations, Canopy Height Model, Sentinel-1, Sentinel-2]  | CNN  | [paper](https://doi.org/10.1038/s41597-023-02455-x)                           | nan                                                   | [data](10.6084/m9.figshare.22202395.v1)         |
